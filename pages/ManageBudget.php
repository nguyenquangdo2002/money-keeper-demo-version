...
?>
        ...
        <div id="page-wrapper">
            ...
            <a href="#new" class="btn white btn-success " style="border-radius: 30px;  border: none; background-color:#9ACD32 " data-toggle="modal"><i class="fa fa-plus"></i> <?php echo $NewBudgets; ?></a>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-warning" style="border-radius: 10px;  " >
                        <div class="panel-heading" style="border-radius: 10px 10px 1px 1px" >
                            <i class="fa fa-archive"></i> <?php echo $HistoryofBudget; ?>
                            
                        </div>
                        <!-- /.panel-heading -->
                       
                            <div class="table-responsive" style=" border-radius: 10px;box-shadow: 10px 10px 10px rgba(0, 0, 0, 0.4); ">
	                	...
	                	<tbody>
							...
							<td colspan="2" class="notification">
								<a href="#EditBudget<?php echo $col['BudgetId'];?>" class="" data-toggle="modal"><span class="btn btn-primary btn-xs glyphicon glyphicon-edit" data-toggle="tooltip" style="border-radius: 5px;" data-placement="left"  title="" data-original-title=" <?php echo $EditBudget; ?>"></span></a>
								<a href="#DeleteBudget<?php echo $col['BudgetId'];?>"  data-toggle="modal"><span class=" glyphicon glyphicon-trash btn btn-primary btn-xs" data-toggle="tooltip" style="border-radius: 5px;" data-placement="right" title="" data-original-title="<?php echo $DeleteBudgets; ?>"></span></button>			
							</td>
							</tr>
	                	</tbody>
